...
public class Registration {
    ...
    public void fillupUserForm() throws InterruptedException {
        ...
        textFields.get(4).sendKeys("fariha"); //first name
        textFields.get(5).sendKeys("fariq123@gmail.com"); //email
        textFields.get(6).sendKeys("qe3ddc123@ud"); //password
        textFields.get(7).sendKeys("jahan"); //last name
        ...
        js.executeScript("arguments[0].value = '1998-04-18';", dobField);
